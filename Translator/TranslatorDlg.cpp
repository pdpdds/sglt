...
BEGIN_MESSAGE_MAP(CTranslatorDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_IMPORT, &CTranslatorDlg::OnBnClickedImport)
END_MESSAGE_MAP()
...
BOOL CTranslatorDlg::UpdateTextState()
{
	BYTE* szTalker = NULL;
	szTalker = m_MsgController->GetTalker();

	GetDlgItem(IDC_STATIC_TALKER)->SetWindowText((LPCTSTR)szTalker);
	 
	return TRUE;
}
void CTranslatorDlg::OnBnClickedImport()
{
	// TODO: Add your control notification handler code here
